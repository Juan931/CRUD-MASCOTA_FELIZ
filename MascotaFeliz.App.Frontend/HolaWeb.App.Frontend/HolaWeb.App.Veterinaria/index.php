...
<body>
  ...
  <a href="../HolaWeb.App.Visitas/index.php" type="button" class="btn btn-outline-info">Visitas</a>
  </div> 
</div>
  <div class="container">
    <h1 class="page-header text-center text-success">Registro Veterinaria</h1>
    <div class="row">
      <div class="col-sm-12">
